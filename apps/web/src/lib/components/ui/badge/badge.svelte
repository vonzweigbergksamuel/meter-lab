	...
	export const badgeVariants = tv({
		...
		variants: {
			variant: {
				...
				warning:
					"bg-yellow-300 [a&]:hover:bg-yellow-300/90 focus-visible:ring-yellow-300/20 dark:focus-visible:		ring-yellow-600/40 dark:bg-yellow-600 border-transparent text-black",
